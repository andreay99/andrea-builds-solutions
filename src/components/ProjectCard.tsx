          ...
          <CardContent className="space-y-6 relative z-10">
            ...
            <div className="space-y-3 pt-2">
              <MagneticButton strength={0.3} distance={100}>
                <Button className="w-full group rounded-lg bg-gradient-to-r from-accent to-accent/80 text-background hover:from-accent hover:to-accent shadow-md hover:shadow-lg transition-all" onClick={(e) => e.preventDefault()}>
              ...
              >
                {githubLink && (
                  <motion.div
                    ...
                    className="flex-1"
                  >
                    <Button asChild variant="outline" size="sm" className="w-full rounded-lg border-foreground/20 hover:border-accent hover:bg-accent/10 transition-all" onClick={(e) => e.stopPropagation()}>
